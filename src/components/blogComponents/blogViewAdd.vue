            ...
            <v-card>
                ...
                <v-card-text>
                    <v-form class="px-3" ref="form">
                        ...
                        <v-file-input accept="image/*" v-model="uploadImage" label="Image"></v-file-input>
            ...
            async submit() {
                if (this.$refs.form.validate()) {
                    ...
                    if (this.uploadImage === '') {
                        ...
                        let imagePost = await this.$http.post(Endpoints.blogImagePost,
                            formData, {
                                headers: {
                    ...
                    this.$http.post(Endpoints.blogItemPost, data).then(() => {
                        this.loading = false;
                        this.dialog = false;
                    });
                }
